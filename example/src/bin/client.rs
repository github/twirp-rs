...
use twirp::url::Url;
use twirp::{Context, GenericError};
...
use service::haberdash::v1::{
    GetStatusRequest, GetStatusResponse, MakeHatRequest, MakeHatResponse,
};
...
impl HaberdasherApi for MockHaberdasherApiClient {
    ...
    async fn make_hat(
        ...
        _ctx: Context,
        _req: MakeHatRequest,
    ) -> Result<MakeHatResponse, Self::Error> {
        todo!()
    }
    ...
    ) -> Result<GetStatusResponse, Self::Error> {
        todo!()
    }
}
